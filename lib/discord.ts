import type { Offer } from "@/lib/olx";
...
export async function sendDiscordOffer(
  ...
  const fields = [
    ...
    },
    {
      inline: true,
      name: "Lokalizacja",
      value: truncate(offer.location || "Brak danych", 1024),
    },
    {
      inline: true,
      name: "Sprzedający",
  ...
  if (offer.delivery) {
    fields.push({ inline: true, name: "Przesyłka OLX", value: "Dostępna" });
  }
